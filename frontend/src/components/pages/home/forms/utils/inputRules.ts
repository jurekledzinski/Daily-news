...
export const passwordRules: Record<string, Validate<string, RegisterFormValues>> = {
...
export const confirmPasswordRules: Record<string, Validate<string | undefined, RegisterFormValues>> = {
  sameValues: (_, rest) => rest.password === rest.confirmPassword || 'Passwords do not match',
};

export const emailRules: Record<string, Validate<string, RegisterFormValues>> = {
  matchPattern: (v) =>
